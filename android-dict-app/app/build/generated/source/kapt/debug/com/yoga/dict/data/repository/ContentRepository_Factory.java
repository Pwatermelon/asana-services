...
public final class ContentRepository_Factory implements Factory<ContentRepository> {
  ...
  public ContentRepository_Factory(Provider<DictApiService> apiServiceProvider) {
  ...
  public static ContentRepository_Factory create(Provider<DictApiService> apiServiceProvider) {
    return new ContentRepository_Factory(apiServiceProvider);
  }

  public static ContentRepository newInstance(DictApiService apiService) {
